;(function ( $, window, document, undefined ) {
	...
	*/
	...
	DjangoModalAjaxForm.prototype.must_hide = function(content){

		if (typeof self.parameters == 'undefined')
			return false;

		if (!self.parameters.hide_on_success)
			return false;

		$.each(self.parameters.error_classes, function( index, error_class ) {
			if (content.includes(error_class))
				return false;
		});
		return true;
	}
	...
	*/
	...
	$.fn.DjangoModalRunner=function(parameters)
    {
       var default_parameters = {
		    ...
		    'error_classes': ['errorlist', 'alert-error']
       };
