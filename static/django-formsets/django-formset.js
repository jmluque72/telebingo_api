...
(function($) {
  ...
  $.fn.djangoFormset.Formset = (function() {
    ...
    Formset.prototype.addForm = function() {
      ...
      newFormElem = this.template.clone().removeClass(this.opts.formTemplateClass).removeClass('hidden');
  ...
  $.fn.djangoFormset.Form = (function() {
    ...
    Form.prototype.getDeleteButton = function() {
      return $("<button style='margin-top: 25px;' type='button' class='btn btn-danger'> " + this.formset.opts.deleteButtonText + " </button>");
    };
    ...
    Form.prototype._replaceDeleteCheckboxWithButton = function() {
      ...
      if (this.formset.opts.insertDeleteButton)
