...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.FileField(storage=bet.storage.OverwriteStorage(), upload_to=bet.models.save_winner_file, null=True, verbose_name='Result to provider', blank=True),
        ),
        migrations.AddField(
